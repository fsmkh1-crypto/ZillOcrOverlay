...
현재 버전은 **0.2.1 · OpenRouter 무료 번역 테스트 버전**입니다.
...
API 키는 현재 private SharedPreferences에 저장합니다. 후속 버전에서 Android Keystore 적용 예정입니다.

## 사용 방법

1. OpenRouter API 키를 입력하고 저장합니다.
2. `번역 캡처 시작`을 누릅니다.
3. Android 화면 공유/캡처 동의 창에서 **전체 화면 캡처**를 허용합니다.
4. PPSSPP로 전환합니다.
...
- 0.2.0 OpenAI 번역 빌드: 성공
- 0.2.1 OpenRouter 무료 번역: GitHub Actions 빌드 후 실기기 확인 예정

## 다음 단계

`TODO.md` 참고. 0.2.1에서 무료 번역 지연/품질/호출 제한을 확인한 뒤 3단계 Room 캐시와 용어집으로 진행합니다.
